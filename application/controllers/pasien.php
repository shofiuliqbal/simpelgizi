...
class pasien extends CI_Controller {
	...
	public function index()
	{
		...
		$data = $this->pasien_model->getData();
		//var_dump($data);die;
		
		//tampilkan ke model
		$this->layout->render('pasien/index', array('data' => $data));
		...
		public function tambah()
	{
		...
		//tampilkan ke model
		$this->layout->render('pasien/form_tambah', array ('data_kamar' => $data_kamar));
	...
	public function ubah(){
		...
		if($this->input->post())
		{
			...
			$data = $this->pasien_model->getOne($id);
		...
		$this->layout->render('pasien/form_ubah', array('data' => $data, 'data_kamar' => $data_kamar, 'error' => $error));
	}
