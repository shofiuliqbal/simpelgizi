            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Perbarui Data Diit Pasien</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
							...
							<form action="<?php echo site_url("diitpasien/ubah")?>" method="post" enctype="multipart/form-data">
							...
							<table border="0" style="width:100%;">
								...
								<tr>
									...
									<td><input class="form-control" type="text" name="nama" value="<?php echo @$data['nama']?>" disabled></input></td>
								</tr>
								<tr>
									<td style="width:200px">Tanggal Lahir</td>
									<td><input class="form-control" data-date-format="yyyy/mm/dd" name="tgl_lahir" value="<?php echo @$data['tgl_lahir']?>" disabled></td>
								</tr>
								<tr>
									<td>Jenis Diit</td>
									<td>
										<select name="id_diit" class="form-control">
											...
											foreach($data_diit as $tb_diit)
												echo "<option value='$tb_diit[id_diit]' selected='$tb_diit[nama_diit]'>$tb_diit[nama_diit]</option>";
											?>
										</select>
									</td>
								</tr>
								<tr>
									<td>Kamar</td>
									<td>
										<select name="id_kamar" class="form-control" disabled>
											<?php
